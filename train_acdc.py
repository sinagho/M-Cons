...
from utils_acdc import DiceLoss, calculate_dice_percase, val_single_volume, BoundaryDoULoss
...
parser.add_argument("--model_name", type=str, default="WaveFormer_cross", help="model_name")
...
args.exp = 'Wave_Prompt_0' + str(args.img_size)
snapshot_path = "{}/{}/{}".format(args.save_path, args.exp, 'Wave_Prompt') # Save_path == Lrz/reza/sina
...
#         net = MaxViT_LargeKernelDualTransformer(num_classes=args.num_classes).cuda(0)
net = Model(
            num_classes=args.num_classes, # Ok
        ).cuda(0)     
