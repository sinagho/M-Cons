...
from datasets.dataset_acdc import ACDCdataset, ACDCdataset_noisy, ACDCdataset_blury, RandomGenerator,ACDCdataset_intensity
from datasets.dataset_acdc import ACDCdataset_intensity as ACDCdataset
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", type=str, default="MaxViT_deform_LKA_TrEcaGanorm", help="model_name")
...
#     torch.cuda.manual_seed(args.seed)
    ...
    if args.model_name == 'MaxViT_deform_LKA_TrEcaGanorm':
        net = Model(num_classes= args.num_classes).cuda(0)
    ...
    snapshot = '/cabinet/reza/sina/model_pth/ACDC/FAN_main_5224/Wave_Prompt_epo220_bs18_lr0.0005_224_s2222/best.pth'
